<!doctype html>
  ...
  <html class="no-js"  <?php language_attributes(); ?>>
	...
	<head>
        ...
        <link rel="alternate" href="https://pregelcolombia.com/" hreflang="es-co" />
		...
		<script>
		  ...
		  ga('create', 'UA-4623260-10', 'auto', {'allowLinker': true});
		  ga('require', 'linker');
          ga('linker:autoLink', ['https://colombia.pregel-itc.com/'] );
		  ga('send', 'pageview');
