				...
				<div class="grid-container">
					<div class="grid-x grid-margin-x" id="pg-about-content-row">
						<div id="event-blurb" class="small-12 large-8 cell">
							<p>En PreGel Colombia ofrecemos nuestros servicios y productos a lo largo del año, a través de ferias comerciales, cursos de capacitación y demostraciones. Nuestra meta es poner a su alcance los mejores ingredientes y servicios de la industria. Para mayor información acerca de cualquiera de los eventos listados, envíenos un correo electrónico a <a href="mailto:info@pregelcolombia.com">info@pregelcolombia.com.</a></p>
						</div>
